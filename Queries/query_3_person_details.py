...
print("Data una persona, restituisce tutti i suoi dati\n")
persona = input("Inserire il nome seguito dal cognome della persona: ")
nome = persona.split()[0]
cognome = persona.split()[1]
